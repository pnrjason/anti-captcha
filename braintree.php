...
curl_setopt_array($ch, array(
    ...
    CURLOPT_POSTFIELDS => "username=$username&email=$username@gmail.com&password=$username&woocommerce-register-nonce=$register_nonce&_wp_http_referer=%2Fmy-account%2Fadd-payment-method%2F&register=Register",
));
